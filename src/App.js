...
export default function App() {
  ...
  const translations = {
    TR: {
      ...
      heroDesc:
        "MEDIVIA ile Türkiye'nin önde gelen sağlık kurumlarını keşfedin. Güvenilir, hızlı ve şeffaf sağlık turizmi deneyimi.",
      ...
      aboutDesc:
        "MEDIVIA, sağlık turizmi alanında güvenilir bilgi, doğru yönlendirme ve dijital kolaylık sunan bir platformdur. Hastalar ile sağlık hizmeti sağlayıcılarını doğrudan buluşturarak zaman kazandırır ve şeffaf bir deneyim sağlar.",
      aboutBoxes: [
      ...
      contactDesc:
        "MEDIVIA ekibi, sağlık turizmi alanında kamu destekli iş birliklerine ve yenilikçi projelere açıktır. Görüşme talebi veya ortaklık için bize ulaşın.",
      ...
      hospitals: [
        {
          ...
          details:
            "X Hastanesi 20 yıllık deneyimiyle, yurt içi ve yurt dışı hastalara multidisipliner tedavi hizmeti sunmaktadır.",
        },
        {
          name: "Y Klinik",
          location: "İzmir",
          ...
          details:
            "Y Klinik, uluslararası diş hekimliği standartlarına uygun ekipmanlarla kişiye özel estetik çözümler üretmektedir.",
        },
        {
          name: "Z Tıp Merkezi",
          location: "Antalya",
          ...
          details:
            "Z Tıp Merkezi, medikal estetik alanında ileri teknoloji kullanarak doğal ve kalıcı sonuçlar sunar.",
        },
      ],
    },
    EN: {
      ...
      heroDesc:
        "Discover Turkey's leading healthcare institutions with MEDIVIA. Reliable, fast and transparent health tourism experience.",
      ...
      aboutDesc:
        "MEDIVIA provides reliable information, accurate guidance and digital convenience in health tourism. It connects patients directly with providers, saving time and offering transparency.",
      aboutBoxes: [
      ...
      contactDesc:
        "The MEDIVIA team is open to public-supported collaborations and innovative projects in health tourism. Contact us for partnerships or meetings.",
      ...
      hospitals: [
        {
          ...
          details:
            "X Hospital offers multidisciplinary medical services to both domestic and international patients with over 20 years of experience.",
        },
        {
          name: "Y Clinic",
          location: "Izmir",
          ...
          details:
            "Y Clinic provides personalized aesthetic dental solutions with international quality standards.",
        },
        {
          ...
          details:
            "Z Medical Center uses advanced technology to deliver natural and lasting results in medical aesthetics.",
        },
      ],
    },
  };
  ...
  const filtered = t.hospitals.filter(
    (h) =>
